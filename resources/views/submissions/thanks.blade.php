...
<body class="bg-gray-50 flex items-center justify-center min-h-screen p-4">
    <div class="bg-white rounded-xl shadow-card p-8 max-w-md w-full text-center">
        <div class="mb-6">
        ...
        <a href="{{ $waLink }}" target="_blank" class="inline-block bg-[#0A8F3C] text-white px-6 py-3 rounded-xl hover:bg-[#047A2D] font-medium">
